                ...
                <div class="card-body">
                    <form action="{{route('task.store')}}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control border border-dark @error('title') is-invalid @enderror" value="{{old('title')}}" id="exampleInputEmail1" name="title" aria-describedby="emailHelp">
                          @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control border border-dark @error('desc') is-invalid @enderror" id="exampleFormControlTextarea1" name="desc" rows="3">{{old('desc')}}</textarea>
                            @error('desc')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="mb-3">
                            <label for="file" class="form-label ">Selfie</label>
                            <input type="file" class="form-control border border-dark @error('file') is-invalid @enderror" value="{{old('file')}}" id="file" name="file" aria-describedby="file">
                            @error('file')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                          </div>
